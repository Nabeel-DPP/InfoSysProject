...
export const importRoleData = async () => {
  try {
    // Use path.resolve to construct the absolute file path
    const filePath = path.resolve('./importData/roleTable.xlsx');  // Adjust path accordingly
    ...
    const result = await Role.insertMany(sheetData);
