  ...
  return (
    <div className="hero-container d-flex flex-column align-items-center justify-content-center text-center">
      <div className="hero-content">
        <p className="display-6 text-white">Welcome</p>
        <p className="display-4 text-white">Mr. Admin</p>
        <h1 className="display-4 text-white">Order, Stock & Salary Management System</h1>
      </div>
