...
const ProductEdit = () => {
  ...
  useEffect(() => {
    if (rowData) {
      setFormData({
        prod_id: rowData.prod_id || '',                 // Set prod_id if it exists, otherwise empty string
      prod_name: rowData.prod_name || '',             // Set prod_name
      prod_form_id: rowData.prod_form_id || '',       // Set prod_form_id
      prod_form_name: rowData.prod_form_name || '',   // Set prod_form_name
      prd_type: rowData.prd_type || '',               // Set prd_type
      generic: rowData.generic || '',                 // Set generic
      compose: rowData.compose || '',                 // Set compose
      pack: rowData.pack || '',                       // Set pack
      thera: rowData.thera || '',                     // Set thera
      strength: rowData.strength || '',               // Set strength
      status: rowData.status || '',                   // Set status
      ...
      ssr_enabled: rowData.ssr_enabled || '',         // Set ssr_enabled
      trading: rowData.trading || '',                 // Set trading
