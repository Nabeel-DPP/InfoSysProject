  ...
  const handleSubmit = async (e) => {
   ...
   console.log("Submitted Data of Form : ", formData);
    try {
        ...
        const response = await axios.post("http://localhost:5555/rights", formData); // Post request to the server's '/area' endpoint
        ...
        if (response.status === 201) {  // Check if the response is OK
          ...
          alert('Failed to Insert Rights Data.');
        }
      } catch (error) {
