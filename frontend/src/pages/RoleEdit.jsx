...
const RoleEdit = () => {
  ...
  const handleSubmit = async (e) => {
   ...
   try {
    await axios.put(`http://localhost:5555/role/${rowData._id}`, formData);
    navigate("/roleTable"); // Navigate back to AreaTable after successful update
  } catch (error) {
  ...
  return (
    ...
    <h1 className="distributor-form__title p-1 w-50 mb-5 ">Role Information</h1>
    <div className="row">
