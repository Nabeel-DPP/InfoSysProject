      ...
      <div className="row">
        ...
        <div className="col-md-12 col-lg-6 col-sm-12">
          <div className="distributor-input-group">
            ...
            <i className="input-icon fa-solid fa-sack-dollar"></i>
            <div className="valid-feedback"><i className="fa-regular fa-circle-check"></i></div>
      ...
      <div className="row">
        <div className="col-md-12 col-lg-6 col-sm-12">
          <div className="distributor-input-group">
            ...
            <i className="input-icon fa-solid fa-filter-circle-dollar"></i>
            <div className="valid-feedback"><i className="fa-regular fa-circle-check"></i></div>
            <div className="invalid-feedback"><i className="fa-solid fa-triangle-exclamation"></i>&nbsp; &nbsp;Please enter a valid address</div>
          </div>
        </div>
      ...
      <div className="row">
        <div className="col-md-12 col-lg-6 col-sm-12">
          <div className="distributor-input-group">
            ...
            <i className="input-icon fa-solid fa-layer-group"></i>
            <div className="valid-feedback"><i className="fa-regular fa-circle-check"></i></div>
            <div className="invalid-feedback"><i className="fa-solid fa-triangle-exclamation"></i>&nbsp; &nbsp;Please enter a valid address</div>
          </div>
        </div>
        ...
        <div className="col-md-12 col-lg-6 col-sm-12">
          <div className="distributor-input-group">
            ...
            <i className="input-icon fa-solid fa-industry"></i>
            <div className="valid-feedback"><i className="fa-regular fa-circle-check"></i></div>
            <div className="invalid-feedback"><i className="fa-solid fa-triangle-exclamation"></i>&nbsp; &nbsp;Please enter the year since the distributor started</div>
          </div>
        </div>
      ...
      <div className="row">
        ...
        <div className="col-md-12 col-lg-6 col-sm-12">
          <div className="distributor-input-group">
            ...
            <i className="input-icon fa-solid fa-mobile-screen"></i>
            <div className="valid-feedback"><i className="fa-regular fa-circle-check"></i></div>
            <div className="invalid-feedback"><i className="fa-solid fa-triangle-exclamation"></i>&nbsp; &nbsp;Please enter the year since the distributor started</div>
          </div>
        </div>
      ...
      <i className="input-icon fa-solid fa-diagram-project mr-5"></i>
        ...
        <div className="col-md-12 col-lg-3 col-sm-12">
          <div className="distributor-input-group">
            ...
            <i className="input-icon fa-solid fa-hashtag"></i>
            <div className="valid-feedback"><i className="fa-regular fa-circle-check"></i></div>
            <div className="invalid-feedback"><i className="fa-solid fa-triangle-exclamation"></i>&nbsp; &nbsp;Please enter a valid address</div>
          </div>
        </div>
        ...
        <div className="col-md-12 col-lg-3 col-sm-12">
          <div className="distributor-input-group">
            ...
            <i className="input-icon fa-solid fa-shop-lock"></i>
            <div className="valid-feedback"><i className="fa-regular fa-circle-check"></i></div>
            <div className="invalid-feedback"><i className="fa-solid fa-triangle-exclamation"></i>&nbsp; &nbsp;Please enter a valid address</div>
          </div>
        </div>
